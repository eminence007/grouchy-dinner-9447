...
const SignUp = () => {
  ...
  const SignUp = () => {
    ...
    function feetcm(e) {
      ...
      let Centimeter = TotalInch / 0.3937;
      setUser((pre) => {
        ...
        <div className="container mx-auto px-20 p-3 rounded-lg bg-white shadow-md shadow-orange-100 mb-4">
          <div className="mb-2 rounded p-2 ">
            ...
            <input
              ...
              className="float-right border-2 rounded p-1"
              placeholder="Email"
            />
          </div>
          <div className="mb-2 rounded p-2">
              ...
              <div className=" flex gap-3 items-center">
                ...
                <div className="">
                  ...
                  <select
                    ...
                    className="p-2 border rounded-md bg-white px-5"
                  >
                    {Month.map((e, i) => {
                      return (
                        <option key={i + ""} value={i + 1}>
        ...
        <div className="container mx-auto px-20 p-3 rounded-lg bg-white shadow-md shadow-orange-100 mb-4 text-md ">
          ...
          <div className="mb-4">
            <div className="flex gap-4 mb-1">
              <input
                type="checkbox"
                className="w-10 checked:bg-gray-900"
                name="check-all"
                id="check-all"
              />
          ...
          <div className="mb-4">
            <div className="flex gap-4 mb-1">
              <input
                type="checkbox"
                name="check-inapp-adds"
                className="w-10 text-green-600"
                id="check-inapp-adds"
              />
